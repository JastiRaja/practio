  ...
  return (
    ...
    <div className=" flex flex-col items-center justify-center px-12 py-12">
      ...
      <div className="  items-center">
       ...
       <center> <div className="flex-1 max-w-xl">
          ...
          <p className="mt-10" > Pract** helps you streamline daily operations while driving strategic growth for your business.</p>
      ...
      <div className="md:w-1/2 ml-40">
        ...
        <p className="text-gray-600 mb-6">
          ...
          integrations. Pract**’s unified data model gives you unparalleled
    ...
    <div className="bg-[#3C1F3F] w-[80%] text-white py-16 px-6 md:px-20 flex flex-col items-center ml-40">
      ...
      <div className="grid md:grid-cols-2 gap-8 w-full max-w-4xl">
        ...
        <div className="bg-[#432E54] p-6 rounded-lg shadow-md">
          ...
          <p className="text-gray-300 text-sm">
            Manage employees with workflows that instantly communicate with other tools. From hiring to app provisioning, Pract** removes the need for manual work.
          </p>
        </div>
      ...
      <p className="text-gray-400 text-center text-sm mt-8 max-w-lg italic">
        "Pract** is a modern tool kit that allows most of our administrative tasks to run on autopilot, so I can spend more time understanding how to support our leaders and team members."
      </p>
    </div>
    ...
    <div className="bg-gray-100 text-[#3C1E29] py-16 px-6 md:px-20 flex flex-col items-center">
      ...
      <p className="text-gray-600 text-center max-w-2xl">
        Report on the trends that matter most and customize programs to address your business’s unique challenges. Pract** empowers HR leaders to deliver more value to their company.
      </p>
    </div>
    ...
    <div className="bg-[#F8F7F5] py-16 px-6 md:px-20 flex flex-col md:flex-row items-center gap-10">
      ...
      <center><div className="">
        ...
        <p className="text-gray-600">
          ...
          Pract** unifies all your data, even from third-party apps, on its platform.
        </p>
      </div></center>
